    ...
    <Grid className={classes.wrapper}>
      <Grid.Col span={{ base: 12, sm: 6 }}>
        ...
        >
          ...
          <List.Item>
            <b>Free and open source</b> – Loyalty cards management app is free and open source, and
            hosted for your convenience by me
          </List.Item>
          <List.Item>
      ...
      <Grid.Col span={{ base: 12, sm: 6 }} className={classes.imageWrapper}>
        <Image src={shopping} />
      </Grid.Col>
    </Grid>
  );
